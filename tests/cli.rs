...
fn sort_test_1() {
    ...
    // test each sort
    cmd1.assert().success().stdout("[1.0, 2.0, 3.0, 4.0]\n[4.0, 3.0, 2.0, 1.0]\n");
    cmd2.assert().success().stdout("[1.0, 2.0, 3.0, 4.0]\n[4.0, 3.0, 2.0, 1.0]\n");
}
...
fn sort_test_2() {
    ...
    // test each sort
    cmd1.assert().success().stdout("[-9.0, -0.5, 10.0, 20.0, 45.2]\n[45.2, 20.0, 10.0, -0.5, -9.0]\n");
    cmd2.assert().success().stdout("[-9.0, -0.5, 10.0, 20.0, 45.2]\n[45.2, 20.0, 10.0, -0.5, -9.0]\n");
}
...
fn point_sort_test_2() {
    let mut cmd1 = Command::cargo_bin("point_sort").unwrap();
    let mut cmd2 = Command::cargo_bin("point_sort_bubble").unwrap();
    cmd1.arg("-0.5").arg("-9").arg("45.2").arg("10").arg("20").arg("1").arg("5");
    cmd2.arg("-0.5").arg("-9").arg("45.2").arg("10").arg("20").arg("1").arg("5");
